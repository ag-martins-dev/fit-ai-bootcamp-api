...
export const aiRoutes = async (app: FastifyInstance) => {
  app.withTypeProvider<ZodTypeProvider>().route({
    ...
    schema: {
      tags: ["AI"],
      summary: "Chat com personal trainer IA",
    },
        ...
        tools: {
          ...
          updateUserTrainData: tool({
            ...
            inputSchema: z.object({
              ...
              bodyFatPercentage: z.number().int().min(0).max(100).describe("Percentual de gordura corporal (0 a 100)"),
            }),
            execute: async (input) => {
              ...
              return upsertUserTrainData.execute({
                ...
                heightInCentimeters: input.bodyFatPercentage,
